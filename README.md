...
Sets: top_k, dense/BM25 weight ratio, temporal threshold, prompt template.
        ...
        ▼
[2. QUERY EMBEDDING]
Embed the raw query using voyage-4-lite.
This is dense retrieval vector.
        │
        ▼
[3. HYBRID RETRIEVAL]
...
Cross-encoder scores true query-document relevance - much more accurate than embedding similarity alone.
Why: embedding retrieval is fast but approximate.
Reranker is slow but precise, run it on a small candidate set, not the whole corpus.
Use: voyageai rerank API.
